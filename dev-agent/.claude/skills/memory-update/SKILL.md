...
- **Cold (`memory/*.md`):** Detailed context by topic — projects, preferences, decisions.

## Steps

1. Read `identity/memory.md` and relevant `memory/*.md` files
2. Identify what's worth keeping: decisions, preferences, project context, architecture choices
